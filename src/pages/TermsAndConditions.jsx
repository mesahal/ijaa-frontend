            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">
                  Welcome to IIT JU Alumni Association
                </h2>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  These Terms and Conditions ("Terms") govern your use of the
                  IIT Jahangirnagar University Alumni Network platform
                  ("Service") operated by the IIT JU Alumni Association ("we",
                  "us", or "our"). By accessing or using our Service, you agree
            ...
            <section>
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  the platform. Your continued use of the Service after such
            ...
            <section>
              ...
              <ul className="space-y-2 text-gray-600 dark:text-gray-300">
                <li className="flex items-center space-x-2">
                  ...
                  <span>
                    You must be a graduate of IIT Jahangirnagar University
                  </span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-success-500" />
              ...
              <div className="space-y-4 text-gray-600 dark:text-gray-300">
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                  ...
                  <p>
                    ...
                    by the same person are prohibited.
                  </p>
                </div>
              </div>
            </section>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    ...
                    functionality are owned by the IIT JU Alumni Association and
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    ...
                    settings. Upon deletion, your profile and associated data
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    We are not responsible for content posted by users. Users
                    are solely responsible for their posts and interactions.
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                  <p className="font-medium text-gray-900 dark:text-white mb-2">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-gray-900 dark:text-white font-medium">
                        IIT Jahangirnagar University, Savar, Dhaka, Bangladesh
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 px-8 py-6 border-t border-gray-200 dark:border-gray-700">
            <div className="flex flex-col sm:flex-row items-center justify-between space-y-2 sm:space-y-0">
              <p className="text-sm text-gray-600 dark:text-gray-300">
                © 2025 IIT Jahangirnagar University Alumni Association. All
                rights reserved.
              </p>
