...
const SignIn = () => {
  ...
  const { signIn, isUser, loading: authLoading } = useAuth();
  ...
  // Don't render sign in page if user is authenticated
  if (isUser()) {
    return null;
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('✅ [SignIn] Login successful, navigating to /user/dashboard');
